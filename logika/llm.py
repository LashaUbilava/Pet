...
prompt = ChatPromptTemplate.from_template(
    "Ты - агент по ответам на вопросы. Тебе будет дан дополнительный контекст, для более развернутого ответа"
    "Если в контексте нет ответа, то ответь на основе своих знаний, и укажи, что в доп контексте нет ответа на такой вопрос"
    "Контекст:\n{context}\n\n"
    "Вопрос: {question}\n\n"
    "Ответ:"
)
